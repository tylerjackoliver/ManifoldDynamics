...
\begin{frame}{Mani-what?}
		\begin{itemize}
			\item A particular case of spacecraft motion -- the Circular-Restricted Three-body Problem (CR3BP) -- studies the mass of a third body under the influence of two other much more massive bodies
...
\begin{frame}{Any questions?}
	\begin{figure}
	\centering
	\animategraphics[loop,height=.7\textheight, autoplay]{5}{gif/final_try-}{0}{265}
